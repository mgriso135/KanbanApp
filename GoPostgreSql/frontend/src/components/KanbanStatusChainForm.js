...
const KanbanStatusChainForm = () => {
    ...
    const handleUpdateStatusOrder = async (kanbanStatusId) => {
        ...
        let name = "";
        if (kanbanStatus && kanbanStatus.kanban_chain_statuses && kanbanStatus.kanban_chain_statuses.length > 0) {
        ...
        console.log('handleUpdateStatusOrder - URL:', `/api/kanban-chain-status/${kanbanStatusId}`, 'payload', {
